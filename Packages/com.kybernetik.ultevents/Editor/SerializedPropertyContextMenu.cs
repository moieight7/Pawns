...
namespace UltEvents.Editor
{
    internal static class SerializedPropertyContextMenu
    {
            ...
            Serialization.PropertyAccessor accessor)
        {
            ...
            {
                property.ModifyValues<UltEventBase>(ultEvent =>
                {
                    ultEvent?.Clear();
                }, "Clear Event");
            });
            ...
            Serialization.PropertyAccessor accessor)
        {
            ...
            AddMenuItem(menu, "Paste Listener (New) %#V", Clipboard.HasCall, () =>
            {
                property.ModifyValues<UltEventBase>(ultEvent =>
               {
                   ...
                   ultEvent._PersistentCalls ??= new List<PersistentCall>();
                   ultEvent._PersistentCalls.Add(call);
        ...
        public static void AddPropertyModifierFunction(
            GenericMenu menu,
